...
➡️ **[Himaya-Setup-1.3.1.exe — latest release](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
end user's machine) → `installer\output\Himaya-Setup-1.3.1.exe`.
...
- or push a tag (`git tag v1.3.1 && git push origin v1.3.1`): a **Release**
