...
➡️ **[Himaya-Setup-1.7.10.exe — latest release](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
end user's machine) → `installer\output\Himaya-Setup-1.7.10.exe`.
...
- or push a tag (`git tag v1.7.10 && git push origin v1.7.10`): a **Release**
