...
➡️ **[Himaya-Setup-1.7.14.exe — latest release](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
end user's machine) → `installer\output\Himaya-Setup-1.7.14.exe`.
...
- or push a tag (`git tag v1.7.14 && git push origin v1.7.14`): a **Release**
