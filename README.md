...
➡️ **[Himaya-Setup-1.4.2.exe — latest release](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
end user's machine) → `installer\output\Himaya-Setup-1.4.2.exe`.
...
- or push a tag (`git tag v1.4.2 && git push origin v1.4.2`): a **Release**
