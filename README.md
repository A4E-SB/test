...
➡️ **[Himaya-Setup-1.2.0.exe — latest release](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
end user's machine) → `installer\output\Himaya-Setup-1.2.0.exe`.
...
- or push a tag (`git tag v1.2.0 && git push origin v1.2.0`): a **Release**
