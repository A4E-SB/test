<p align="center"><img src="assets/logo.png" width="240" alt="Logo Himaya"></p>
...
➡️ **[Himaya-Setup-1.0.4.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
`Himaya-Setup-1.0.4.exe /VERYSILENT /SUPPRESSMSGBOXES`
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.0.4.exe`.
...
- ou poussez un tag (`git tag v1.0.4 && git push origin v1.0.4`) : une
