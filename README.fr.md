...
➡️ **[Himaya-Setup-1.7.7.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.7.7.exe`.
...
- ou poussez un tag (`git tag v1.7.7 && git push origin v1.7.7`) : une
