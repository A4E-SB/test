<p align="center"><img src="assets/himaya-banner.png" width="240" alt="Logo Himaya"></p>
...
➡️ **[Himaya-Setup-1.0.5.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.0.5.exe`.
...
- ou poussez un tag (`git tag v1.0.5 && git push origin v1.0.5`) : une
