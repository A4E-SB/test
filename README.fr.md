...
➡️ **[Himaya-Setup-1.7.0.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
`Himaya-Setup-1.7.0.exe /VERYSILENT /SUPPRESSMSGBOXES`
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.7.0.exe`.
...
- ou poussez un tag (`git tag v1.7.0 && git push origin v1.7.0`) : une
