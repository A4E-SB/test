...
➡️ **[Himaya-Setup-1.0.1.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.0.1.exe`.
