...
➡️ **[Himaya-Setup-1.7.15.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
`Himaya-Setup-1.7.15.exe /VERYSILENT /SUPPRESSMSGBOXES`
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.7.15.exe`.
...
- ou poussez un tag (`git tag v1.7.15 && git push origin v1.7.15`) : une
