...
➡️ **[Himaya-Setup-1.7.11.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
`Himaya-Setup-1.7.11.exe /VERYSILENT /SUPPRESSMSGBOXES`
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.7.11.exe`.
...
- ou poussez un tag (`git tag v1.7.11 && git push origin v1.7.11`) : une
