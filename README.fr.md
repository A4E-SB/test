...
➡️ **[Himaya-Setup-1.2.2.exe — dernière version](https://github.com/belmezouarsouhil95-byte/test/releases/latest)**
...
`Himaya-Setup-1.2.2.exe /VERYSILENT /SUPPRESSMSGBOXES`
...
build — jamais chez l'utilisateur final) → `installer\output\Himaya-Setup-1.2.2.exe`.
...
- ou poussez un tag (`git tag v1.2.2 && git push origin v1.2.2`) : une
