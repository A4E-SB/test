...
from .widgets import (BarChart, F, StatCard, make_tree, row_tag,
                      status_badge_text, trust_badge_text)
...
class DashboardPage(ctk.CTkScrollableFrame):
    def __init__(self, master, app):
        ...
        self.card_shipped = StatCard(self, app.t("dash_today_shipped"), color=config.COLOR_ACCENT,
        ...
        self.card_blacklist = StatCard(self, app.t("dash_blacklist_size"),
                                       color=config.COLOR_RED, on_click=lambda: go("transfer"))
