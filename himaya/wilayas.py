...
Used for customer addresses, order filters and delivery labels.
"""
...
WILAYA_NAMES_FR = [w[1] for w in WILAYAS]
WILAYA_NAMES_AR = [w[2] for w in WILAYAS]


def wilaya_ar(name_fr: str) -> str:
    """Arabic name for a wilaya stored under its French name."""
    for _code, fr, ar in WILAYAS:
        if fr.lower() == (name_fr or "").strip().lower():
            return ar
    return name_fr or ""
